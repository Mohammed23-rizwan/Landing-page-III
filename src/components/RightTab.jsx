...
const RightTab = () => {
  return (
    <div className="lg:w-[25%] w-full bg-white sticky right-[-17px] no-scrollbar overflow-y-scroll box-content scroll-smooth shadow-[rgba(0,_0,_0,_0.24)_0px_3px_8px]">
